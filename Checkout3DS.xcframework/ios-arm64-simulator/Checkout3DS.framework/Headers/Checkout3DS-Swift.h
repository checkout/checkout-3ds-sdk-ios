...
/// A response from the card issuer could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3309 = 3309,
...
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3565 = 3565,
...
///   </li>
///   <li>
///     locale: (optional) The customer’s locale and preferred language, used to localise the user interface. If no value is set, the device locale is used. (E.g. “en_GB”)
///   </li>
///   <li>
///     uiCustomization: The customizations for the challenge user interface. See <a href="x-source-tag://UICustomization">UICustomization</a> for more information.
///   </li>
/// </ul>
...
@property (nonatomic, readonly) float shadowOpacity;
- (nonnull instancetype)init;
/// Initializes a DefaultContinueButtonCustomization object available
- (nonnull instancetype)initWithBackgroundColor:(UIColor * _Nonnull)backgroundColor cornerRadius:(CGFloat)cornerRadius cornerCurve:(CALayerCornerCurve _Nonnull)cornerCurve font:(UIFont * _Nonnull)font textColor:(UIColor * _Nonnull)textColor borderWidth:(CGFloat)borderWidth borderColor:(CGColorRef _Nullable)borderColor shadowColor:(CGColorRef _Nullable)shadowColor shadowOffset:(CGSize)shadowOffset shadowRadius:(CGFloat)shadowRadius shadowOpacity:(float)shadowOpacity OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly) float shadowOpacity;
- (nonnull instancetype)init;
/// Initializes a DefaultResendButtonCustomization object available
- (nonnull instancetype)initWithBackgroundColor:(UIColor * _Nonnull)backgroundColor cornerRadius:(CGFloat)cornerRadius cornerCurve:(CALayerCornerCurve _Nonnull)cornerCurve font:(UIFont * _Nonnull)font textColor:(UIColor * _Nonnull)textColor borderWidth:(CGFloat)borderWidth borderColor:(CGColorRef _Nullable)borderColor shadowColor:(CGColorRef _Nullable)shadowColor shadowOffset:(CGSize)shadowOffset shadowRadius:(CGFloat)shadowRadius shadowOpacity:(float)shadowOpacity OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly) float shadowOpacity;
- (nonnull instancetype)init;
/// Initializes a DefaultVerifyButtonCustomization object available
- (nonnull instancetype)initWithBackgroundColor:(UIColor * _Nonnull)backgroundColor cornerRadius:(CGFloat)cornerRadius cornerCurve:(CALayerCornerCurve _Nonnull)cornerCurve font:(UIFont * _Nonnull)font textColor:(UIColor * _Nonnull)textColor borderWidth:(CGFloat)borderWidth borderColor:(CGColorRef _Nullable)borderColor shadowColor:(CGColorRef _Nullable)shadowColor shadowOffset:(CGSize)shadowOffset shadowRadius:(CGFloat)shadowRadius shadowOpacity:(float)shadowOpacity OBJC_DESIGNATED_INITIALIZER;
@end
...
/// The app is installed manually.
  Checkout3DSWarningManualInstall = 6,
/// A dynamic code instrumentation toolkit. It enables to inject snippets of JavaScript or library into native apps.
  Checkout3DSWarningFrida = 7,
};
