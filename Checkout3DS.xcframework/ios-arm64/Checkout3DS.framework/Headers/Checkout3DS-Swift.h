...
/// An invalid Session Secret was provided.
  Checkout3DSAuthenticationErrorInvalidSessionSecret = 1001,
...
/// A client or server connection was severed in the middle of an in-progress load. See <a href="https://developer.apple.com/documentation/foundation/1508628-url_loading_system_error_codes/nsurlerrornetworkconnectionlost">NSURLErrorNetworkConnectionLost</a> for more detail.
  Checkout3DSAuthenticationErrorConnectionLost = 2003,
/// The attempted connection required activating a data context while roaming, but international roaming is disabled. See <a href="https://developer.apple.com/documentation/foundation/nsurlerrorinternationalroamingoff">NSURLErrorInternationalRoamingOff</a> for more detail.
  Checkout3DSAuthenticationErrorInternationalRoamingOff = 2004,
/// The URL Loading System encountered an error that it can’t interpret (see <a href="https://developer.apple.com/documentation/foundation/nsurlerrorunknown">NSURLErrorUnknown</a>), or the error code received from URLSession does not match the ones above.
...
/// A response from the card issuer could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3301 = 3301,
/// A response from the card issuer could not be validated.
...
/// A response from the 3DS Server could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3502 = 3502,
/// A response from the 3DS Server could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3503 = 3503,
/// A response from the 3DS Server could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3504 = 3504,
/// A response from the 3DS Server could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3505 = 3505,
/// A response from the 3DS Server could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3506 = 3506,
/// A response from the 3DS Server could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3507 = 3507,
/// A response from the 3DS Server could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3508 = 3508,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3509 = 3509,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3510 = 3510,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3511 = 3511,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3512 = 3512,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3513 = 3513,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3514 = 3514,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3515 = 3515,
/// A response from the card issuer could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3516 = 3516,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3517 = 3517,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3518 = 3518,
/// A response from the card issuer could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3519 = 3519,
/// A response from the card issuer could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3520 = 3520,
/// A response from the 3DS Server could not be validated.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3522 = 3522,
/// The SDK identified an error in the 3D Secure process.
...
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3531 = 3531,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3532 = 3532,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3533 = 3533,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3534 = 3534,
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3535 = 3535,
/// The SDK identified an error in the 3D Secure process.
...
/// The SDK identified an error in the 3D Secure process.
  Checkout3DSAuthenticationErrorThreeDS2ProtocolError3539 = 3539,
/// A response from the card issuer could not be validated.
...
/// An internal SDK error occurred.
  Checkout3DSAuthenticationErrorInternalError4000 = 4000,
/// An internal SDK error occurred.
/// An internal SDK error occurred.
...
/// An internal SDK error occurred.
  Checkout3DSAuthenticationErrorInternalError4015 = 4015,
/// An internal SDK error occurred.
  Checkout3DSAuthenticationErrorInternalError4016 = 4016,
/// An internal SDK error occurred.
  Checkout3DSAuthenticationErrorInternalError4017 = 4017,
/// An internal SDK error occurred.
...
/// An internal SDK error occurred.
  Checkout3DSAuthenticationErrorInternalError4021 = 4021,
/// An internal SDK error occurred.
  Checkout3DSAuthenticationErrorInternalError4022 = 4022,
/// An internal SDK error occurred.
...
/// An internal SDK error occurred.
  Checkout3DSAuthenticationErrorInternalError4029 = 4029,
/// An internal SDK error occurred.
...
/// An internal SDK error occurred.
  Checkout3DSAuthenticationErrorInternalError4033 = 4033,
/// An internal SDK error occurred.
...
/// A debugger is attached to the App.
  Checkout3DSWarningDebuggerAttached = 1,
/// A emulator is being used to run the App.
  Checkout3DSWarningRunningOnSimulator = 2,
/// The device is jailbroken.
  Checkout3DSWarningJailbroken = 3,
/// The integrity of the SDK has been tampered.
  Checkout3DSWarningIntegrityTampered = 4,
};
